...
import io.quarkus.registry.catalog.StreamCatalog;
...
public class PlaygroundRegistryClient implements RegistryClient {
	...
	public PlatformCatalog resolvePlatforms(String quarkusVersion) throws RegistryResolutionException {
		...
		catalog.setDefaultPlatform(playgroundBom);
		final JsonPlatform platform = new JsonPlatform();
		platform.setBom(playgroundBom);
		platform.setQuarkusCoreVersion(quarkusVersion == null ? "999-SNAPSHOT" : quarkusVersion);
	...
	@Override
	public StreamCatalog resolveStreams() throws RegistryResolutionException {
